...
class ViewController: UIViewController {
    ...
    @IBAction func buttonPressed(_ sender: UIButton) {
        ...
        if sender.tag == 1 && storyTextView.text == story1 {
            print("Ugh... you're getting into a stranger's car!!!")
            storyTextView.text = story3
            topButton.setTitle(answer3a, for: .normal)
            bottomButton.setTitle(answer3b, for: .normal)
        } else if sender.tag == 2 && storyTextView.text == story1 {
            print("Better play it safe yes...")
            ...
            topButton.setTitle("Replay Story", for: .normal)
            ...
            topButton.setTitle(answer3a, for: .normal)
            bottomButton.setTitle(answer3b, for: .normal)
        } else if sender.tag == 1 && (storyTextView.text == story4 || storyTextView.text == story5 || storyTextView.text == story6) {
            startOver()
        }
